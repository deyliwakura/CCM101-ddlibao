...
This laboratory activity focuses on understanding the fundamental components of cloud infrastructure. Using the KillerCoda Playground, Linux tools, official cloud documentation, and a GitHub Cloud Computing Portfolio, the activity investigates how compute, storage, networking, and identity services work together.

The mission simulates the planning phase of a cloud deployment. It also emphasizes the importance of documenting technical findings and infrastructure decisions clearly and professionally.
